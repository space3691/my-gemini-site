...
const projectData = {
  development: {
    ...
    details: "Peregrine's development methodology is rooted in identifying untapped potential. We manage the entire lifecycle of an asset, from greenfield acquisition and zoning approvals to architectural design and structural completion. By integrating cutting-edge sustainable practices and collaborating with world-renowned architects, we ensure that every project not only yields exceptional financial returns but also enriches the surrounding community. Our portfolio reflects an unwavering commitment to creating resilient, future-proof spaces that stand as enduring testaments to architectural integrity and strategic foresight."
  },
  otr: {
    title: "OTR",
...
const HomeView = ({ setPage }) => (
  <>
    ...
    {/* Showcase Section: Top-Aligned labels fix */}
